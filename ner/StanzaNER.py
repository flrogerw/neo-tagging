...
class StanzaNER(Pipeline):
    def __init__(self, languages, use_gpu=False, *args, **kwargs):
        ...
        for language in languages:
            ...
            self.text_processors[language] = Pipeline(download_method=DownloadMethod.REUSE_RESOURCES, lang=language, processors='tokenize,mwt,ner')

        # Initialize the Stanza pipeline for language identification
        # super().__init__(download_method=DownloadMethod.REUSE_RESOURCES, lang="en", use_gpu=use_gpu, processors='tokenize,ner,mwt')
